...
class Hotel(object):
    def __init__(self, hotel_name, place, room_mid_quant,  room_mid_price, lux_room_quant , lux_room_price):
...
class Tour(Hotel, Taxi):
    def __init__(
            self, hotel_name, place, room_mid_quant,
            room_mid_price, lux_room_quant, lux_room_price,
            taxi_name, car_types, price_for_tour, tour_name
    ):
        Hotel.__init__(self, hotel_name, place, room_mid_quant,  room_mid_price, lux_room_quant, lux_room_price)
...
my_tour = Tour("Little Tai", "Bangkok", 5, 300, 3, 1000, "Pantera", "Comfort", 600, "Bali")
